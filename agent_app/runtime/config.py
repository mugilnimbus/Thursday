...
class AppConfig:
    ...
    def from_env(cls) -> "AppConfig":
        ...
        return cls(
            ...
            skill_dir=env_path("SKILL_DIR", "agent_app/skills/packages"),
            ...
            current_location=env_str("CURRENT_LOCATION", ""),
            reminder_timezone=env_str("REMINDER_TIMEZONE", "UTC"),
            reminder_poll_seconds=env_int("REMINDER_POLL_SECONDS", 60),
        )

    def public(self) -> dict[str, object]:
        data = asdict(self)
        for key in ("root_dir", "static_dir", "prompt_dir", "skill_dir", "visual_check_dir", "image_upload_dir", "log_dir", "log_db_file", "lmstudio_raw_log_file", "preferences_file"):
