    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                "tool_name": {
                    "type": "string",
                    "description": "Lowercase snake_case tool name. This becomes agent_app/tools/system/<tool_name>.py.",
                },
                "description": {
                    "type": "string",
...
RESERVED_MODULES = {"__init__", "api", "base", "context", "dispatcher", "parsers", "registry", "results"}
...
def run(context: ToolContext, args: dict[str, Any]) -> dict[str, Any]:
    ...
    tools_dir = Path(__file__).parents[1] / "system"
...
def build_tool_scaffold(
    ...
    return (
        ...
        "def run(context: ToolContext, args: dict[str, Any]) -> dict[str, Any]:\n"
        "    # args is the parsed unified tool input object. The registry wraps this result\n"
        "    # into {ok, tool, output, error, meta} before returning it to the LLM.\n"
        "    return {\n"
        "        \"ok\": False,\n"
