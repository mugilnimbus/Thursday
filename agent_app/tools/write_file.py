...
TOOL_DEFINITION = {
    ...
    "function": {
        "name": TOOL_NAME,
        "description": "Create or fully overwrite a UTF-8 text file in the Docker workspace. Use for new files or complete replacements. Provide the full desired file content. Parent folders are created automatically.",
        "parameters": {
            "type": "object",
            "properties": {
